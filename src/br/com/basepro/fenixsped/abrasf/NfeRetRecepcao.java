...
public class NfeRetRecepcao extends ClienteServico {
	...
	//} else if (codigoMunicipio.equalsIgnoreCase("261160-v01")) {
            ...
            br.com.basepro.fenixsped.abrasf.recifev01.Nfse_v01Stub.ConsultarSituacaoLoteRpsRequest envio = new br.com.basepro.fenixsped.abrasf.recifev01.Nfse_v01Stub.ConsultarSituacaoLoteRpsRequest();
            envio.setInputXML(getConteudoXML());                   
            br.com.basepro.fenixsped.abrasf.recifev01.Nfse_v01Stub.ConsultarSituacaoLoteRpsResponse resposta = servico.consultarSituacaoLoteRps(envio); 
        ...
        //SE FOR CUIABA
            ...
            br.com.basepro.fenixsped.abrasf.issnetonline204.NfseWSServiceStub.ConsultarLoteRps envio = new br.com.basepro.fenixsped.abrasf.issnetonline204.NfseWSServiceStub.ConsultarLoteRps();
...
"</cabecalho>");
            inputReq.setNfseDadosMsg(getConteudoXML().substring(39)); 
            envio.setConsultarLoteRps(inputReq);

//            br.com.basepro.fenixsped.abrasf.issnetonline204.NfseWSServiceStub.ConsultarLoteRpsResponse resposta = servico.consultarLoteRps(envio);
//            setRetorno(resposta.getConsultarLoteRpsResponse().getOutputXML());
            setRetorno(servico.consultarLoteRps2String(envio));
        ...
        //SE FOR DOURADOS
            ...
            br.com.basepro.fenixsped.abrasf.bethav1.NfseWSServiceStub.ConsultarLoteRpsE envio = new br.com.basepro.fenixsped.abrasf.bethav1.NfseWSServiceStub.ConsultarLoteRpsE();
            
            br.com.basepro.fenixsped.abrasf.bethav1.NfseWSServiceStub.ConsultarLoteRps inputReq = new br.com.basepro.fenixsped.abrasf.bethav1.NfseWSServiceStub.ConsultarLoteRps();
            ...
            br.com.basepro.fenixsped.abrasf.bethav1.NfseWSServiceStub.ConsultarLoteRpsResponseE resposta = servico.consultarLoteRps(envio);
            setRetorno(resposta.getConsultarLoteRpsResponse().get_return());
            ...
            br.com.basepro.fenixsped.abrasf.sinop4.Nfse_web_serviceStub.Nfse_web_serviceCONSULTARLOTERPS envio = new br.com.basepro.fenixsped.abrasf.sinop4.Nfse_web_serviceStub.Nfse_web_serviceCONSULTARLOTERPS();
...
"			    </cabecalho>");
            ...
            envio.setConsultarloterpsrequest(inputReq);
            br.com.basepro.fenixsped.abrasf.sinop4.Nfse_web_serviceStub.Nfse_web_serviceCONSULTARLOTERPSResponse resposta = servico.cONSULTARLOTERPS(envio);
            setRetorno(resposta.getConsultarloterpsresponse().getOutputXML());
            ...
            */
            ...
            br.com.basepro.fenixsped.abrasf.lem.NfseStub.ConsultarLoteRpsRequest envio = new br.com.basepro.fenixsped.abrasf.lem.NfseStub.ConsultarLoteRpsRequest();
            envio.setNfseCabecMsg(NFSE_CABECALHO_MSG);
            envio.setNfseDadosMsg(getConteudoXML());           
            br.com.basepro.fenixsped.abrasf.lem.NfseStub.ConsultarLoteRpsResponse resposta = servico.consultarLoteRps(envio);
            setRetorno(resposta.getOutputXML());
