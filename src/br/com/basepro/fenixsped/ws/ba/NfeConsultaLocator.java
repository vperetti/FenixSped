...
public class NfeConsultaLocator extends org.apache.axis.client.Service implements br.com.basepro.fenixsped.ws.ba.NfeConsulta {
    ...
    private java.lang.String NfeConsultaSoap_address = "https://hnfe.sefaz.ba.gov.br/webservices/nfe/NfeConsulta.asmx";
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap_PortType getNfeConsultaSoap() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap_PortType getNfeConsultaSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap_BindingStub(portAddress, this);
    ...
    private java.lang.String NfeConsultaSoap12_address = "https://hnfe.sefaz.ba.gov.br/webservices/nfe/NfeConsulta.asmx";
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap_PortType getNfeConsultaSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap_PortType getNfeConsultaSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap12Stub _stub = new br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap_BindingStub(new java.net.URL(NfeConsultaSoap_address), this);
                _stub.setPortName(getNfeConsultaSoapWSDDServiceName());
                return _stub;
            }
            if (br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap12Stub _stub = new br.com.basepro.fenixsped.ws.ba.NfeConsultaSoap12Stub(new java.net.URL(NfeConsultaSoap12_address), this);
                _stub.setPortName(getNfeConsultaSoap12WSDDServiceName());
                return _stub;
            }
        }
