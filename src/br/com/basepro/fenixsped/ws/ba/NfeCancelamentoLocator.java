...
public class NfeCancelamentoLocator extends org.apache.axis.client.Service implements br.com.basepro.fenixsped.ws.ba.NfeCancelamento {
    ...
    private java.lang.String NfeCancelamentoSoap_address = "https://hnfe.sefaz.ba.gov.br/webservices/nfe/NfeCancelamento.asmx";
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap_PortType getNfeCancelamentoSoap() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap_PortType getNfeCancelamentoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap_BindingStub(portAddress, this);
    ...
    private java.lang.String NfeCancelamentoSoap12_address = "https://hnfe.sefaz.ba.gov.br/webservices/nfe/NfeCancelamento.asmx";
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap_PortType getNfeCancelamentoSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap_PortType getNfeCancelamentoSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap12Stub _stub = new br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap_BindingStub(new java.net.URL(NfeCancelamentoSoap_address), this);
                _stub.setPortName(getNfeCancelamentoSoapWSDDServiceName());
                return _stub;
            }
            if (br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap12Stub _stub = new br.com.basepro.fenixsped.ws.ba.NfeCancelamentoSoap12Stub(new java.net.URL(NfeCancelamentoSoap12_address), this);
                _stub.setPortName(getNfeCancelamentoSoap12WSDDServiceName());
                return _stub;
            }
        }
