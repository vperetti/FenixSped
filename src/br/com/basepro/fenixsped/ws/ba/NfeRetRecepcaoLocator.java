...
public class NfeRetRecepcaoLocator extends org.apache.axis.client.Service implements br.com.basepro.fenixsped.ws.ba.NfeRetRecepcao {
    ...
    private java.lang.String NfeRetRecepcaoSoap12_address = "https://hnfe.sefaz.ba.gov.br/webservices/nfe/NfeRetRecepcao.asmx";
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap_PortType getNfeRetRecepcaoSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap_PortType getNfeRetRecepcaoSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap12Stub _stub = new br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap12Stub(portAddress, this);
    ...
    private java.lang.String NfeRetRecepcaoSoap_address = "https://hnfe.sefaz.ba.gov.br/webservices/nfe/NfeRetRecepcao.asmx";
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap_PortType getNfeRetRecepcaoSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap_PortType getNfeRetRecepcaoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap12Stub _stub = new br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap12Stub(new java.net.URL(NfeRetRecepcaoSoap12_address), this);
                _stub.setPortName(getNfeRetRecepcaoSoap12WSDDServiceName());
                return _stub;
            }
            if (br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.ba.NfeRetRecepcaoSoap_BindingStub(new java.net.URL(NfeRetRecepcaoSoap_address), this);
                _stub.setPortName(getNfeRetRecepcaoSoapWSDDServiceName());
                return _stub;
            }
        }
