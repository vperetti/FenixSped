 ...
 * @author vinicius
 */
public class NfeRetRecepcao3 extends ClienteServico {
	public static void main(String[] args) throws Exception {
        ...
        recebeParametros(args);
         ...
         if (getCodUf().equalsIgnoreCase("51")){
            ...
            br.com.basepro.fenixsped.ws.mt3.NfeRetAutorizacaoStub.NfeDadosMsg dadosMsg = br.com.basepro.fenixsped.ws.mt3.NfeRetAutorizacaoStub.NfeDadosMsg.Factory.parse(dad);
            br.com.basepro.fenixsped.ws.mt3.NfeRetAutorizacaoStub.NfeCabecMsg cabecMsg = new br.com.basepro.fenixsped.ws.mt3.NfeRetAutorizacaoStub.NfeCabecMsg();
            cabecMsg.setCUF(getCodUf());
            cabecMsg.setVersaoDados(getVersaoDados());
            br.com.basepro.fenixsped.ws.mt3.NfeRetAutorizacaoStub.NfeCabecMsgE cabecMsgE = new br.com.basepro.fenixsped.ws.mt3.NfeRetAutorizacaoStub.NfeCabecMsgE();
            cabecMsgE.setNfeCabecMsg(cabecMsg);
            br.com.basepro.fenixsped.ws.mt3.NfeRetAutorizacaoStub stub = new br.com.basepro.fenixsped.ws.mt3.NfeRetAutorizacaoStub(getCaminhoWebService());
            setRetorno(stub.nfeRetAutorizacaoLote(dadosMsg, cabecMsgE).getExtraElement().toString());
