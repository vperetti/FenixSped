 ...
 * @author vinicius
 */
public class NfeStatusServico4 extends ClienteServico {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (getCodUf().equalsIgnoreCase("50")){
            ...
            br.com.basepro.fenixsped.ws.nfestatusservico4.NFeStatusServico4Stub.NfeDadosMsg dadosMsg = br.com.basepro.fenixsped.ws.nfestatusservico4.NFeStatusServico4Stub.NfeDadosMsg.Factory.parse(dad);
            br.com.basepro.fenixsped.ws.nfestatusservico4.NFeStatusServico4Stub stub = new br.com.basepro.fenixsped.ws.nfestatusservico4.NFeStatusServico4Stub(getCaminhoWebService());
            setRetorno(stub.nfeStatusServicoNF(dadosMsg).getExtraElement().toString());
