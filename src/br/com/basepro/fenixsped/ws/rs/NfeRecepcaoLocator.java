...
public class NfeRecepcaoLocator extends org.apache.axis.client.Service implements br.com.basepro.fenixsped.ws.rs.NfeRecepcao {
    ...
    private java.lang.String NfeRecepcaoSoap_address = "https://homologacao.nfe.sefaz.rs.gov.br/ws/nferecepcao/NfeRecepcao.asmx";
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap_PortType getNfeRecepcaoSoap() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap_PortType getNfeRecepcaoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap_BindingStub(portAddress, this);
    ...
    private java.lang.String NfeRecepcaoSoap12_address = "https://homologacao.nfe.sefaz.rs.gov.br/ws/nferecepcao/NfeRecepcao.asmx";
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap_PortType getNfeRecepcaoSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap_PortType getNfeRecepcaoSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap12Stub _stub = new br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap_BindingStub(new java.net.URL(NfeRecepcaoSoap_address), this);
                _stub.setPortName(getNfeRecepcaoSoapWSDDServiceName());
                return _stub;
            }
            if (br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap12Stub _stub = new br.com.basepro.fenixsped.ws.rs.NfeRecepcaoSoap12Stub(new java.net.URL(NfeRecepcaoSoap12_address), this);
                _stub.setPortName(getNfeRecepcaoSoap12WSDDServiceName());
                return _stub;
            }
        }
