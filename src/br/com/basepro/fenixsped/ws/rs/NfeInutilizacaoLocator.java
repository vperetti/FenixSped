...
public class NfeInutilizacaoLocator extends org.apache.axis.client.Service implements br.com.basepro.fenixsped.ws.rs.NfeInutilizacao {
    ...
    private java.lang.String NfeInutilizacaoSoap12_address = "https://homologacao.nfe.sefaz.rs.gov.br/ws/nfeinutilizacao/NfeInutilizacao.asmx";
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap_PortType getNfeInutilizacaoSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap_PortType getNfeInutilizacaoSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap12Stub _stub = new br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap12Stub(portAddress, this);
    ...
    private java.lang.String NfeInutilizacaoSoap_address = "https://homologacao.nfe.sefaz.rs.gov.br/ws/nfeinutilizacao/NfeInutilizacao.asmx";
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap_PortType getNfeInutilizacaoSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap_PortType getNfeInutilizacaoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap12Stub _stub = new br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap12Stub(new java.net.URL(NfeInutilizacaoSoap12_address), this);
                _stub.setPortName(getNfeInutilizacaoSoap12WSDDServiceName());
                return _stub;
            }
            if (br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.rs.NfeInutilizacaoSoap_BindingStub(new java.net.URL(NfeInutilizacaoSoap_address), this);
                _stub.setPortName(getNfeInutilizacaoSoapWSDDServiceName());
                return _stub;
            }
        }
