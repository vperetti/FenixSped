...
public class NfeStatusServicoLocator extends org.apache.axis.client.Service implements br.com.basepro.fenixsped.ws.rs.NfeStatusServico {
    ...
    private java.lang.String NfeStatusServicoSoap12_address = "https://homologacao.nfe.sefaz.rs.gov.br/ws/nfestatusservico/NfeStatusServico.asmx";
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap_PortType getNfeStatusServicoSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap_PortType getNfeStatusServicoSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap12Stub _stub = new br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap12Stub(portAddress, this);
    ...
    private java.lang.String NfeStatusServicoSoap_address = "https://homologacao.nfe.sefaz.rs.gov.br/ws/nfestatusservico/NfeStatusServico.asmx";
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap_PortType getNfeStatusServicoSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap_PortType getNfeStatusServicoSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap12Stub _stub = new br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap12Stub(new java.net.URL(NfeStatusServicoSoap12_address), this);
                _stub.setPortName(getNfeStatusServicoSoap12WSDDServiceName());
                return _stub;
            }
            if (br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap_BindingStub _stub = new br.com.basepro.fenixsped.ws.rs.NfeStatusServicoSoap_BindingStub(new java.net.URL(NfeStatusServicoSoap_address), this);
                _stub.setPortName(getNfeStatusServicoSoapWSDDServiceName());
                return _stub;
            }
        }
