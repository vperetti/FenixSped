 ...
 * @author vinicius
 */
public class RecepcaoEvento4 extends ClienteServico {
	...
	public static void main(String[] args) throws Exception {
		...
		if (getCodUf().equalsIgnoreCase("50")) {
			...
			xmlInputFactory.setProperty(XMLInputFactory.IS_NAMESPACE_AWARE, Boolean.FALSE);
			XMLStreamReader dad = xmlInputFactory.createXMLStreamReader(new StringReader("<nfeDadosMsg>" + getConteudoXML().substring(38) + "</nfeDadosMsg>"));
			br.com.basepro.fenixsped.ws.recepcaoevento4.NFeRecepcaoEvento4Stub.NfeDadosMsg dadosMsg = br.com.basepro.fenixsped.ws.recepcaoevento4.NFeRecepcaoEvento4Stub.NfeDadosMsg.Factory.parse(dad);
			br.com.basepro.fenixsped.ws.recepcaoevento4.NFeRecepcaoEvento4Stub stub = new br.com.basepro.fenixsped.ws.recepcaoevento4.NFeRecepcaoEvento4Stub(getCaminhoWebService());
			setRetorno(stub.nfeRecepcaoEvento(dadosMsg).getExtraElement().toString());
