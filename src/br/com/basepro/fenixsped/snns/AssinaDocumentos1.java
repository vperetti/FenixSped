...
public class AssinaDocumentos1 {
    ...
    public void assinar(String caminhoXml, String caminhoCertificado, String senha, String caminhoXmlNovo) throws Exception {
        ...
        if (tipoDocumento.equals("DPS")) {
            ...
            tag = "infInut";
	} else if (tipoDocumento.equals("envEvento")) {
            tag = "infEvento";
        } else {
        ...
        for (int i = 0; i < doc.getDocumentElement().getElementsByTagName(tag).getLength(); i++) {
            ...
            Element el = (Element) elements.item(i);
            String id = el.getAttribute("Id");
	    el.setIdAttribute("Id", true); ///aqui
	    System.out.print("Assinara elem 3 snns" + i + " ID " + id );
            Reference ref = fac.newReference("#" + id, fac.newDigestMethod(DigestMethod.SHA1, null), transformList, null, null);
...
//        }
    ...
    public void assinar_betha(String caminhoXml, String caminhoCertificado, String senha, String caminhoXmlNovo) throws Exception {
        String tag = "";
        String tipoDocumento = "";
...
//        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            AssinaDocumentos1 t = new AssinaDocumentos1();
            if (isLote(caminhoXml)){
                ...
                bufferLoteAss.deleteCharAt(bufferLoteAss.length()-1);
                ...
                FileWriter fw = new FileWriter(caminhoXml);
    ...
    public static boolean isLote(String caminhoXml) throws Exception {
        ...
        if (docs.getDocumentElement().getNodeName().equals("enviNFe")) {
            return true;
        }else{
            return false;
        }
